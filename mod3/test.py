...
def get_the_fastest_func(funcs, arg=None):
    ...
    for func in funcs:
        ...
        func(arg) if arg is not None else func()  # Проверка на наличие аргумента
...
print(get_the_fastest_func([for_and_append, list_comprehension, list_function], range(1000000)))
